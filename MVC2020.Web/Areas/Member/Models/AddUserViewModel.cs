...
namespace MVC2020.Web.Areas.Member.Models
{
    ...
    //模型中使用到了远程验证（Remote）、属性比较（Compare）等验证方式。
        ...
        public class AddUserViewModel
        {
            ...
            /// 用户名
            /// </summary>
            //[Remote("CanUsername","User",HttpMethod = "Post",ErrorMessage = "用户名已存在")]      //远程验证（Remote）
            ...
            /// 确认密码
            /// </summary>
            [System.ComponentModel.DataAnnotations.Compare("Password",ErrorMessage = "两次输入的密码不一致")]  //属性比较（Compare）
            [DataType(DataType.Password)]
            [Display(Name = "确认密码")]
